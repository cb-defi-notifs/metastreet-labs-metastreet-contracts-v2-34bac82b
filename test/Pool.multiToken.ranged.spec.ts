...
describe("Pool Batch Ranged Collection", function () {
  ...
  before("deploy fixture", async () => {
    ...
    multiTokenTokenId = (await extractEvent(mintTx, multiTokenCollateralWrapper, "BatchMinted")).args.tokenId;
    multiTokenData = (await extractEvent(mintTx, multiTokenCollateralWrapper, "BatchMinted")).args.encodedBatch;
