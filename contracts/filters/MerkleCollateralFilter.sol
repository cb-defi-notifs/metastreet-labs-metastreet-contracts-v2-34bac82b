...
contract MerkleCollateralFilter is CollateralFilter {
    ...
    function _initialize(address token, bytes memory params) internal {
        /* Decode parameters */
        (bytes32 root, uint32 nodeCount) = abi.decode(params, (bytes32, uint32));
     ...
     */
    function _merkleProof(bytes calldata context, uint256 nodeCount) internal pure returns (bytes32[] memory) {
