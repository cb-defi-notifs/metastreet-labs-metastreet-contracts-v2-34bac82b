...
/**
 * @title ERC1155 Multi Token Collateral Wrapper
 */
contract MultiTokenCollateralWrapper is ICollateralWrapper, ERC721, ERC1155Holder, ReentrancyGuard {
    /**************************************************************************/
    /* Constants */
    /**************************************************************************/
     ...
     */
    constructor() ERC721("MetaStreet Multi Token Collateral Wrapper", "MSMTCW") {}
    ...
    function name() public pure override(ERC721, ICollateralWrapper) returns (string memory) {
        return "MetaStreet Multi Token Collateral Wrapper";
    }
    ...
    /**
     * @notice Deposit a ERC1155 collateral into contract and mint a MultiTokenCollateralWrapper token
     *
     * Emits a {BatchMinted} event
     *
     * @dev Collateral token, nonce, token ids, batch size, and multipliers are encoded,
     * hashed and stored as the MultiTokenCollateralWrapper token ID.
    ...
    function mint(
        ...
        /* Mint MultiTokenCollateralWrapper token */
