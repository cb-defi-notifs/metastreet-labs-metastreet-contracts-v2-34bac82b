...
contract PunkProxy {
    ...
    ICryptoPunksMarket public immutable exchange;
    ...
    // --- Constructor ---
    constructor(address cryptoPunksMarket) {
        exchange = ICryptoPunksMarket(cryptoPunksMarket);
    }
    ...
    function checkOnERC721Received(address from, address to, uint256 tokenId, bytes memory data) private {
        if (to.isContract()) {
